...
<body id="dt_example">
	...
	<h1>Employment Maintenance</h1>
		<table  align="center" class="display" cellpadding="10"  id="example"> 
			...
			{?>
			<tr>
				<td><?php echo $cnt; echo form_open('maintenance/dayupdate');?></td>
				<td><?php echo form_input('title',$row->title);?></td>
				<td><?php echo form_input('desc',$row->desc);?></td>
				<td><?php echo form_input('payrate',$row->payrate);?></td>
				<td>
				<?php
