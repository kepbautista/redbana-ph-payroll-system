...
function addPhilhealth($N,$response){
	$response = $response.'<table><tr>
		<td>&nbsp&nbsp</td>
		<th> Monthly <br /> Salary <br /> Bracket </th>
		<th colspan="2"> Monthly <br /> Salary <br /> Range </th>
		<th> Salary Base <br /> (SB) </th>
		<th> Total Monthly <br /> Contributions </th>
		<th> Employee Share <br /> (EeS) <br /> (EeS = 0.5 x TMC) </th>
		<th> Employer Share <br /> (ErS) <br /> (ErS = 0.5 x TMC) </th>
		</tr>';
